...
class AppViewModelFactory(private val app: PrepApp) : ViewModelProvider.Factory {
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T = when (modelClass) {
        ...
        ChapterViewModel::class.java -> ChapterViewModel(contentRepo, userDao, profileRepo) as T
        McqViewModel::class.java -> McqViewModel(contentRepo, bookmarkRepo, profileRepo) as T
        TestViewModel::class.java -> TestViewModel(contentRepo, attemptRepo, profileRepo) as T
        TestResultViewModel::class.java -> TestResultViewModel(userDao, contentRepo) as T
        QAViewModel::class.java -> QAViewModel(contentRepo, bookmarkRepo) as T
        ProfileViewModel::class.java -> ProfileViewModel(profileRepo, attemptRepo) as T
        ...
        SamplePaperViewModel::class.java -> SamplePaperViewModel(paperRepo, contentRepo, attemptRepo, profileRepo) as T
        GamesHubViewModel::class.java -> GamesHubViewModel(gameRepo) as T
        ...
        SpeedChallengeViewModel::class.java -> SpeedChallengeViewModel(gameRepo, contentRepo, profileRepo) as T
        DailyChallengeViewModel::class.java -> DailyChallengeViewModel(contentRepo, attemptRepo, profileRepo) as T
